...
# All the frames
song_frame = LabelFrame(root, text='Current Song', bg='violet', width=400, height=80)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(root, text='Control Buttons', bg='purple', width=400, height=120)
...
# Playlist ListBox
playlist = Listbox(listbox_frame, font=('Helvetica', 11), selectbackground='purple')
...
# SongFrame Labels
Label(song_frame, text='CURRENTLY PLAYING:', bg='white', font=('Times', 10, 'bold')).place(x=5, y=20)
...
Label(root, textvariable=song_status, bg='Violet', font=('Times', 9), justify=LEFT).pack(side=BOTTOM, fill=X)
